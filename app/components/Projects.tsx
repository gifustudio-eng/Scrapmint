...
const PROJECTS: Project[] = [
  {
    ...
    thumb: "/project_material_recovery.jpeg",
    location: "Jakarta, Indonesia — Malls Partnership",
    ...
    modal: {
      ...
      intro: "We worked with Malls in Indonesia to bring their waste to Material Recovery Facilities (MRFs), instead of having it go directly to landfill. The result: up to 80% of waste diverted. Three phases drove this — a public campaign, on-site education, and sourcing processing partners.",
      cards: [
        {
          ...
          title: "#MulaiDariSini",
          sub: "Campaign Launch",
          desc: "Malls commit publicly to divert waste from landfill. The campaign set a new standard for waste management in Indonesia's retail sector.",
        },
        {
          img: "/modal_tenant_education.jpeg",
          alt: "Panel discussion — Scrapmint tenant education",
          title: "Tenant Education",
          sub: "Scrapmint Education to Mall Tenants",
          desc: "We ran awareness sessions directly with mall tenants — driving waste segregation behavior at the source before material reaches the MRF.",
        },
        {
          img: "/modal_material_recovery.jpeg",
          alt: "Pemilahan sampah di MRF — Material Recovery Facility operations",
  ...
  },
  {
    ...
    status: "Active",
    statusClass: "status-active",
    thumb: "/project_innovative_recycling.jpeg",
  ...
  },
  {
    ...
    location: "Indonesia — Riverside Golf Course & Malls",
